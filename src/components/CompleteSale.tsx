...
export function CompleteSale({ products, customers, machines, onSaveTransaction, onSaveCustomer }: CompleteSaleProps) {
  ...
  const handleFinishSale = () => {
    ...
    // Reset form after saving to show in success screen if needed, but actually we need it for printing
  };
